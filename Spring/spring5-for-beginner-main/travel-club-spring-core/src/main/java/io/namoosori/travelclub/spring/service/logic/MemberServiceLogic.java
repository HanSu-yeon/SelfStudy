...
import io.namoosori.travelclub.spring.store.mapstore.MemberMapStore;
...
public class MemberServiceLogic implements MemberService {
    ...
    public MemberMapStore memberStore;

    public MemberServiceLogic(MemberMapStore memberMapStore) {
        this.memberStore = memberMapStore;
    }
