...
* resolveToken메소드는 HttpServeltRequest객체의 Header에서 token을 꺼내는 역할을 수행한다
* */
public class JwtFilter extends GenericFilterBean {
    ...
    /*실제 필터링 로직은 doFilter메소드를 오버라이드하여 작성한다
     *doFilter 메소드는 jwt토큰의 인증 정보를 현재 실행중인 스레드(Security Context)에 저장한다*/
    @Override
